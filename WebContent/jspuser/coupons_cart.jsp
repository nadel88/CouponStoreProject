    ...
    <div class="container">
        ...
        <div class="row">
         ...
         <%if(userName.getUserName().equals("guest")){ %>
        	<h3>Register to access the coupon cart</h3>
        	<%} %>
    ...
    <%for(int i = 0 ; i<couponList.getCouponList() .size() ; i++ ){ Coupon c = couponList.getCouponList().get(i);if(c.isAvailable()) {%>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
               ...
               <a class="btn btn-primary" href="servlet/CouponUserServlet/cart_remove?idremove=<%=i%>">Delete Item From Cart <span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
        </div>
        <!-- /.row -->
