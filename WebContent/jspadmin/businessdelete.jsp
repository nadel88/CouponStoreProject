...
<head>
<%Iterator<Coupon> list_coupon = (Iterator<Coupon>)session.getAttribute("businesslist"); %>
     ...
     <div id="wrapper"> 
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                <div class="col-lg-6">
                	<h3><u>Delete Business</u></h3>
                        <p>In this Form you can delete an existing business from the Data Base by entering the business name</p><hr>
                        <form method="post" action=<%= request.getContextPath() +"/servlet/CouponAdminServlet/removebusiness"%>>
                        	<br><h3> business name: </h3> <input type="text" class="form-control input-lg" name="businessname" /> 
							<br>
							<br>
                    ...
                    <div class="col-lg-12">
						...
						<br>
						<h3><u>List of all the businesses:</u></h3>
						<hr><br>
						<%for(int i = 1 ;list_coupon.hasNext() ; i++ ){ Coupon c = list_coupon.next(); %>
        				<div class="row">
                			<h1>Business ID: <%=c.getBusiness_id() %></h1>
        			</div>
       			 <!-- /.row -->
       		  <hr>  
			<%} %>
