            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                	<h3><u>Update Coupon</u></h3>
                        <p>In this Form you can update any property of any coupon</p>
                        <p>make sure to supply a correct id (greater than 0) and a correct propery name.</p>
                        <form method="post" action=<%= request.getContextPath() +"/servlet/CouponAdminServlet/update"%>>
                        	<br><h3> Coupon Id: </h3> <input type="text" class="form-control input-lg" name="couponid" /> 
							<br><h3>Select Field to update:</h3><select class="form-control input-lg" name="colname">
  								<option>id</option>
                    ...
                    <div class="col-lg-12">
            			...
            			<div class="col-md-6">
                			...
                			<h4>Business ID: <%=c.getBusiness_id() %></h4>
               			 	...
               			 	<p>Expire Date:<%=c.getExpiredate() %></p>
